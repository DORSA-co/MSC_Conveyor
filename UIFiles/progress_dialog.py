...
class Ui_progressDialog(object):
    def setupUi(self, progressDialog):
        ...
        progressDialog.setMinimumSize(QSize(700, 300))
        progressDialog.setMaximumSize(QSize(700, 400))
...
"")
        ...
        self.title_lbl = QLabel(progressDialog)
        ...
        self.description_lbl = QLabel(progressDialog)
        ...
        self.progress_frame = QFrame(progressDialog)
        ...
        self.buttons_frame = QFrame(progressDialog)
...
"}")
    ...
    def retranslateUi(self, progressDialog):
        ...
        self.label_2.setText(QCoreApplication.translate("progressDialog", u"/", None))
