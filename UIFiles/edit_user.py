...
class Ui_editUserDialogWin(object):
    def setupUi(self, editUserDialogWin):
        ...
        editUserDialogWin.resize(377, 533)
        ...
        self.StyleSheet = QWidget(editUserDialogWin)
...
"\n"
"#save_btn, #cancel_btn{\n"
"	background-color: qlineargradient(spread:pad, x1:0, y1:0.505682, x2:1, y2:0.477, stop:0 rgb(126, 132, 162), stop:1 r"
                        "gb(31, 42, 77));\n"
...
"}\n"
"\n"
"#save_btn:pressed, #cancel_btn:pressed {\n"
"	padding-left: 5px;\n"
"	padding-top: 5px;\n"
"}\n"
"\n"
"#main_frame{\n"
"	border-image: url(:/icons/icons/bg_image2.jpg);\n"
"	border-radius: 20px;\n"
"}\n"
"\n"
"#inner_frame{\n"
...
"}")
        ...
        self.verticalLayout_5.setContentsMargins(25, 10, 25, -1)
        ...
        self.verticalLayout_6.addWidget(self.role_label)
        ...
        self.verticalLayout_6.addWidget(self.role_combobox)
