...
class Ui_CalendarDialog(object):
    def setupUi(self, CalendarDialog):
        ...
        CalendarDialog.setCursor(QCursor(Qt.UpArrowCursor))
...
"{\n"
"    icon: url(:/icons/icons/prev_gray.png);\n"
"	background-color: transparent;\n"
"	min-height: 40px;\n"
"	max-height: 40px;\n"
"	min-width: 40px;\n"
...
"{\n"
"    icon: url(:/icons/icons/next_gray.png);\n"
"	background-color: transparent;\n"
"	min-height: 40px;\n"
"	max-height: 40px;\n"
"	min-width: 40px;\n"
...
"{\n"
"	background-color: qlineargradient(spread:pad, x1:0.635, y1:1, x2:0.44, y"
                        "2:0, stop:0 rgba(77, 98, 153, 255), stop:1 rgba(114, 152, 252, 255));\n"
"}\n"
"\n"
