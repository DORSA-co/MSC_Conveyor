...
class LiveView_API:
    ...
    def __init__(self, uiHandeler:LiveView_UI , db_Report):
    ...
    def new_defect_event(self, defect:Defect):
        notif = defectNotification(1, 
                                   'material_side', 
                                   defect.jdatetime, 
                                   'should be change', 
                                   (100,200,20)
                                   )
        self.uiHandeler.append_notification(notif)
    ...
    #     self.uiHandeler.button_connector_QTimer(self.start_selection_camera)

    # def button_connector_Stop(
    #   self,
    # ):  ###################  for getting image from camera
    #     self.uiHandeler.button_connector_stop()
    ...
    #         ch = 3
    #     bytes_per_line = ch * w
    #     self.uiHandeler.set_Pixmap(img.data, w, h, bytes_per_line)
    ...
    #             self.uiHandeler.set_style_Camera(styles_Live_Camera)
    ...
    #             self.uiHandeler.connect_Camera_liveView_button()
    #             self.uiHandeler.set_Meassage_on_API("Connect to Camera Successfully")

    #         else :

    #             self.uiHandeler.set_Meassage_on_API("Please check the connection to the camera")
    ...
    #         self.camera=None
    #         self.uiHandeler.disconnect_Camera_liveView_button()
    #         self.uiHandeler.set_Meassage_on_API("Disconnect to Camera Successfully")
             

    # def show_farme_camera(self):  ###################  for getting image from  the camera
        
    #     t1=time.time()
    #     self.uiHandeler.disable_live()
    #     self.uiHandeler.enable_stop()
    ...
    #                 self.uiHandeler.set_style_laser(styles_Live_Laser)
    ...
    #                     }
    #                 # self.uiHandeler.set_style_information(styles_Live)
    ...
    #                             }
    #                         self.uiHandeler.set_general_information(infoes_Live)
    #                         #print(max_depth)
